...
export default function Footer() {
  return (
    // CHANGED: bg-gray-900 -> bg-green-700
    // CHANGED: border-gray-800 -> border-green-800
    <footer className="bg-green-700 text-white py-12 px-6 border-t border-green-800">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
               {/* CHANGED: Replaced "M" placeholder with Image */}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a href="mailto:support@matcharoommate.com" className="flex items-center gap-3 text-green-100 hover:text-white transition-colors group">
                <div className="w-8 h-8 rounded-lg bg-green-800/50 flex items-center justify-center group-hover:bg-green-600 transition-colors border border-green-600/30">
